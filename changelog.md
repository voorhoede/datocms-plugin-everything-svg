...
## [1.2.4] - 2026-03-13
### Fixed
- Fix migration error by adding environment parameter.
...
## [1.2.1] - 2026-03-10
### Fixed
- Use a DatoCMS model to store SVGs to fix saving content above the parameters size limit of 10KB.

## [1.2.0] - 2025-04-14
### Added
- SVGs will now show up in the record preview in a collections view. If there's more than one field using the plugin, it will default to the first field with non-empty data.
...
[1.3.0]: https://github.com/voorhoede/datocms-plugin-everything-svg/compare/v1.2.4...v1.3.0
[1.2.4]: https://github.com/voorhoede/datocms-plugin-everything-svg/compare/v1.2.3...v1.2.4
